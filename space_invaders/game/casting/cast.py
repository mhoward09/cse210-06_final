class Cast:
    ...
    def __init__(self):
        ...
        self._actors = {} #defines the _actors attribute as a dictionary of groups of actors of different purposes - each actor or object in the game will have a group with which it is associated and manages the addition and removal of all game objects within that group.
