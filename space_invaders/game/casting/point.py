class Point:
    ...
    def __init__(self, x = 0, y = 0):
        ...
        """
        self._x = x #defines the x component of the point from the args
        self._y = y #defines the y component of the point from the args
    ...
    def add(self, other):
        ...
        """
        x = self._x + other.get_x() #adds the x components
        y = self._y + other.get_y() #adds the y components
        return Point(x, y)
    ...
    def reverse(self):
        ...
        """
        new_x = self._x * -1 #changes the sign of the x component
        new_y = self._y * -1 #changes the sign of the y component
