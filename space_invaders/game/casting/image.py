class Image:
    ...
    def __init__(self, filename, scale = 1, rotation = 0):
        ...
        self._filename = filename #defines the filename attribute from the args - this will be the file path to the image
        self._scale = scale #defines the scale attribute from the args - this is the size of the image
        self._rotation = rotation #defines the rotation attribute from the args - this is if the images spins or turns
